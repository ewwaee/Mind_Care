...
import 'package:doctor_app_fixed/widgets/category_box.dart';
import 'package:doctor_app_fixed/widgets/popular_doctor.dart';
      ...
      SingleChildScrollView(
        child: Padding(
          ...
          child: Column(
              ...
              children: [
                const Text("Hi,", style: TextStyle(fontSize: 23, color: primary, fontWeight: FontWeight.w500),),
                const SizedBox(height: 5,),
                const Text("Let's Find Your Doctor", style: TextStyle(fontSize: 18, fontWeight: FontWeight.w600),),
                ...
                const SizedBox(height: 25,),
                const Text("Popular Doctors", style: TextStyle(fontSize: 16, fontWeight: FontWeight.w600),),
                const SizedBox(height: 10),
                SingleChildScrollView(
