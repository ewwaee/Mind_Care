...
class ChatItem extends StatelessWidget {
  const ChatItem(this.chatData, { super.key, this.onTap});
  final chatData;
                    ...
                    child:
                      Column(
                        ...
                        children: [
                          ...
                          Row(
                            children: <Widget>[
                              Text(chatData['skill'], maxLines: 1, overflow: TextOverflow.ellipsis, style: const TextStyle(fontSize: 13, color: Colors.grey)),
                            ],
                          ),
